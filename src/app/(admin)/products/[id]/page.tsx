    ...
    <div className="bg-gray-50 -m-6 p-6 min-h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-6">
        ...
        <div className="bg-white rounded-2xl shadow p-5 flex flex-col">
          <div className="flex-1 flex items-center justify-center bg-gray-50 rounded-xl overflow-hidden min-h-[220px]">
            {selectedImage ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={selectedImage} alt={product.product_name} className="max-h-52 max-w-full object-contain" />
            ) : (
            ...
            <div className="flex gap-2 mt-3">
              {images.map((img, i) => (
                <button
                  ...
                  className={`w-14 h-14 rounded-lg overflow-hidden border-2 ${selectedImage === img ? 'border-blue-500' : 'border-gray-200'}`}
                >
                  {/* eslint-disable-next-line @next/next/no-img-element */}
